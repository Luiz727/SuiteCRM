...
$mod_strings = array(
    ...
    'help' => array(
        ...
        'studioWizard' => array(
            ...
            'moduleHelp' => 'Os componentes que você pode personalizar para o módulo aparecem aqui.<br><br>Clique em um ícone para selecionar o componente para editar.<br><br>Clique em <b>Reiniciar o Módulo</b> para remover as personalizações e restaurar o status original.',
...
//STUDIO2
    ...
    'LBL_SUITEPORTAL' => 'Editor do Portal do SuiteCRM',
...
//EXPORT CUSTOMS
    ...
    'LBL_EC_SUITEFEEDS' => 'feed(s) personalizado(s)',
...
//POPUP HELP
    ...
    'LBL_POPHELP_IMPORTABLE' => '<b>Sim</b>: O campo será incluído em uma operação de importação.<br>
<b>Não</b>: O campo não será incluído em uma importação.<br>
<b>Obrigatório</b>: Um valor para o campo deve ser fornecido em qualquer importação.',
    'LBL_POPHELP_IMAGE_WIDTH' => 'Insira um número para largura conforme a medida em pixels.<br> A imagem carregada será dimensionada para esta largura.',
    'LBL_POPHELP_IMAGE_HEIGHT' => 'Insira um número para largura conforme a medida em pixels.<br> A imagem carregada será dimensionada para esta largura.',
    'LBL_POPHELP_DUPLICATE_MERGE' => '<b>Ativado</b>: O campo vai aparecer no recurso de Mesclar Duplicados, mas não estará disponível para uso para as condições do filtro no recurso Localizar Duplicadas.<br><b>Desativado</b>: O campo não aparecerá na função Mesclar Duplicados, e não estará disponível para uso para as condições do filtro no recurso Localizar Duplicadas.<br><b>Filtro</b>: O campo irá aparecer no recurso de Mesclar Duplicados, e estará disponível para uso para as condições do filtro no recurso Encontrar Duplicadas.<br><b>Filtro Selecionado Padrão</b>: O campo irá aparecer no recurso de Mesclar Duplicados, e será usado por padrão para as condições do filtro no recurso Encontrar Duplicadas.<br><b>Somente Filtro</b>: O campo não aparecerá no recurso de Mesclar Duplicados, mas estará disponível para uso para as condições do filtro no recurso Encontrar Duplicados.',
