...
$mod_strings = array(
    ...
    'LBL_DATE_SENT_RECEIVED' => 'Data enviada/recebida:',
    ...
    'LBL_LIST_DATE_SENT_RECEIVED' => 'Data enviada/recebida',
    ...
    'LBL_BUTTON_DELETE_IMAP' => 'Excluir do IMAP',
    ...
    'LBL_QUICK_CREATE_SUCCESS1' => 'O registro foi criado com sucesso.',
    'LBL_QUICK_CREATE_SUCCESS2' => 'Clique em OK para visualizar o novo registro.',
    'LBL_QUICK_CREATE_SUCCESS3' => 'Clique em Cancelar para retornar para o E-mail.',
    ...
    'ERR_FIELD_FROM_IS_EMPTY' => 'O campo \'De\' está vazio.',
    'ERR_FIELD_FROM_IS_INVALID' => 'O campo \'De\' é inválido.',
    'ERR_FIELD_FROM_ADDR_IS_NOT_SET' => 'Endereço do remetente não definido.',
    'ERR_FIELD_FROM_ADDR_IS_EMPTY' => 'Endereço do remetente está vazio.',
    'ERR_FIELD_FROM_ADDR_IS_INVALID' => 'Endereço do remetente é inválido.',
    'ERR_FIELD_FROMNAME_IS_NOT_SET' => 'Nome do remetente não definido.',
    'ERR_FIELD_FROMNAME_IS_EMPTY' => 'Nome do remetente está vazio.',
    'ERR_FIELD_FROMNAME_IS_INVALID' => 'Nome do remetente é inválido.',
    'ERR_FIELD_FROM_NAME_IS_NOT_SET' => 'Nome do remetente não definido.',
    'ERR_FIELD_FROM_NAME_IS_EMPTY' => 'Nome do remetente está vazio.',
    'ERR_FIELD_FROM_NAME_IS_INVALID' => 'Nome do remetente é inválido.',
    'ERR_FIELD_FROM_ADDR_NAME_IS_NOT_SET' => 'O conjunto endereço e nome do remetente não está definido.',
    'ERR_FIELD_FROM_ADDR_NAME_IS_EMPTY' => 'O conjunto endereço e nome do remetente está vazio.',
    'ERR_FIELD_FROM_ADDR_NAME_IS_INVALID' => 'O conjunto endereço e nome do remetente é inválido.',
    'ERR_FIELD_FROM_ADDR_NAME_DOESNT_MATCH_REGEX' => 'O formato do conjunto endereço e nome do remetente está incorreto, use "from@emailaddress.org <Nome da pessoa>".',
    'ERR_FIELD_FROM_ADDR_NAME_INVALID_NAME_PART' => 'A parte \'nome\' está inválida no conjunto endereço e nome do remetente.',
    'ERR_FIELD_FROM_ADDR_NAME_INVALID_EMAIL_PART' => 'A parte \'endereço\' está inválida no conjunto endereço e nome do remetente.',
    'ERR_FIELD_FROM_ADDR_NAME_INVALID_EMAIL_PART_TO_FIELD_FROM' => 'O conjunto endereço e nome do remetente não coincidem com o endereço ou nome do remetente.',
    'ERR_FIELD_FROM_ADDR_NAME_INVALID_EMAIL_PART_TO_FIELD_FROM_ADDR' => 'O conjunto endereço e nome do remetente não coincide com o endereço do remetente.',
    'ERR_FIELD_FROM_ADDR_NAME_INVALID_EMAIL_PART_TO_FIELD_FROMNAME' => 'O conjunto endereço e nome do remetente não coincide com o nome do remetente.',
    'ERR_FIELD_FROM_ADDR_NAME_INVALID_EMAIL_PART_TO_FIELD_FROM_NAME' => 'O conjunto endereço e nome do remetente não coincide com o nome do remetente.',
);
